...
import data from './data/nigeria.json';
...
const allArticles: Article[] = data.sections.flatMap(
  (section) => section.articles
);

export const searchNigerianBuildingCodes = ai.defineTool(
  {
    name: 'searchNigerianBuildingCodes',
    description:
      'Searches the Nigerian National Building Code (2006) for articles relevant to a query. Returns articles that match keywords or concepts in the query.',
